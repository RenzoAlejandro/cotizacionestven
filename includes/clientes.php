                ...
                <tbody>
                    <?php foreach ($clientes as $cliente) { ?>
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-warning" href="<?php echo BASE_URL ?>/?p=editar_cliente&id=<?php echo $cliente->id ?>">
                                    <i class="fa fa-edit"></i>
                                </a>
                            </td>
                            <td>
                                <a class="btn btn-danger" href="<?php echo BASE_URL ?>/?p=eliminar_cliente&id=<?php echo $cliente->id ?>&tokenCSRF=<?php echo $tokenCSRF ?>">
