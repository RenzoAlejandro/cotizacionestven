    ...
    <div class="col-sm">
        <form method="post" action="<?php echo BASE_URL ?>/?p=actualizar_cliente">
            ...
            <div class="form-group">
                ...
                <input value="<?php echo htmlentities($cliente->razonSocial) ?>" autofocus name="razonSocial" autocomplete="off" required type="text" class="form-control" id="razonSocial" placeholder="Por ejemplo: Luis Cabrera Benito">
            </div>
