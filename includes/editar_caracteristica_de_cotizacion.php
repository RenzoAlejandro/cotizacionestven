...
<div class="col-sm-4">
    ...
    <form method="post" action="<?php echo BASE_URL ?>/?p=actualizar_caracteristica_de_cotizacion">
        ...
        <div class="form-group">
            ...
            <input value="<?php echo $caracteristica->caracteristica; ?>" autofocus name="caracteristica" autocomplete="off" required type="text" class="form-control" id="caracteristica" placeholder="Algo que describa a la cotización">
        </div>
