...
$resultado = Mensajes::guardar($_POST["remitente"], $_POST["mensajePresentacion"], $_POST["mensajeAgradecimiento"], $_POST["mensajePie"]);
Utiles::redireccionar("editar_mensajes&mensaje=" . intval($resultado));
