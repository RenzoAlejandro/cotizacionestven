    ...
    <div class="col-sm">
        <form method="post" action="<?php echo BASE_URL ?>/?p=guardar_cotizacion">
            ...
            <div class="form-group">
                ...
                <input autofocus name="descripcion" autocomplete="off" required type="text" class="form-control" id="descripcion" placeholder="Por ejemplo: Sistema de ventas, Construcción de casa">
            </div>
            <div class="form-group">
