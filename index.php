...
include_once BASE_PATH . "/controllers/Mensajes.php";
...
$PAGINAS_SESION_REQUERIDA = [
    ...
    "agregar_producto_a_cotizacion",
    "editar_producto_de_cotizacion", "eliminar_producto_de_cotizacion",
    "actualizar_producto_de_cotizacion",
    ...
    "imprimir_cotizacion",
    # Mensajes
    "editar_mensajes", "actualizar_mensajes",
    # Acerca de
    "creditos",
];
